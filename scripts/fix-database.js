...
async function fixDatabase() {
  ...
  try {
    ...
    console.log(`✅ Updated ${destResult.modifiedCount} destinations to admin-owned\n`);
    ...
    console.log(`✅ Updated ${guideResult.modifiedCount} guides to admin-owned\n`);
    ...
    const adminDests = destinations.filter(d => d.postedBy?.toString() === adminUser._id.toString());
    const adminGuides = guides.filter(g => g.postedBy?.toString() === adminUser._id.toString());
    ...
    console.log('3. Login as regular user - they should see ONLY admin-created items');
