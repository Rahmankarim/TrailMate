...
export default function AuthForm() {
  ...
  function validate() {
    ...
    if (tab === "signup" && !fields.role) errs.role = "Please select a role"
    if (tab === "signup" && fields.role === "company" && !fields.companyName.trim())
      errs.companyName = "Company name required"
    return errs
  }
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-1 items-center justify-center bg-gradient-to-br from-emerald-100 to-blue-100 relative">
        <Image src={brand.bg || "/placeholder.svg"} alt="Adventure" fill className="object-cover opacity-80" priority />
                  ...
                  <div className="flex gap-4 mb-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        name="role"
                        value="company"
                        checked={fields.role === "company"}
                        onChange={(e) => setFields((f) => ({ ...f, role: "company" }))}
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => setFields((f) => ({ ...f, role: "user" }))}
                        className="accent-emerald-700"
                      />
                ...
                <span className="mr-2">
                  <svg width="22" height="22" viewBox="0 0 48 48">
                    <g>
                      <path
                        fill="#4285F4"
                        d="M24 9.5c3.54 0 6.7 1.23 9.19 3.25l6.85-6.85C35.54 2.34 30.07 0 24 0 14.61 0 6.27 5.7 2.44 14.1l7.98 6.21C12.13 13.16 17.56 9.5 24 9.5z"
                      />
                      <path
                        fill="#34A853"
                        d="M46.09 24.56c0-1.56-.14-3.06-.41-4.5H24v9.05h12.44c-.54 2.9-2.18 5.36-4.64 7.03l7.18 5.59C43.98 37.36 46.09 31.44 46.09 24.56z"
                      />
                      <path
                        fill="#FBBC05"
                        d="M10.42 28.31c-.62-1.86-.98-3.83-.98-5.81s.36-3.95.98-5.81l-7.98-6.21C.8 13.7 0 18.7 0 24s.8 10.3 2.44 14.52l7.98-6.21z"
                      />
                      <path
                        fill="#EA4335"
                        d="M24 48c6.07 0 11.54-2.01 15.81-5.47l-7.18-5.59c-2.01 1.35-4.59 2.15-7.63 2.15-6.44 0-11.87-3.66-14.58-8.81l-7.98 6.21C6.27 42.3 14.61 48 24 48z"
                      />
                    </g>
                  </svg>
                </span>
